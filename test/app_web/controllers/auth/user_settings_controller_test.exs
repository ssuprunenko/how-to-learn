defmodule AppWeb.Auth.UserSettingsControllerTest do
  ...
  describe "PUT /auth/users/settings/update_password" do
    test "updates the user password and resets tokens", %{conn: conn, user: user} do
      new_password_conn =
        put(conn, Routes.auth_user_settings_path(conn, :update_password), %{
  ...
  describe "PUT /auth/users/settings/update_email" do
    @tag :capture_log
    test "updates the user email", %{conn: conn, user: user} do
      conn =
        put(conn, Routes.auth_user_settings_path(conn, :update_email), %{
          "current_password" => valid_user_password(),
